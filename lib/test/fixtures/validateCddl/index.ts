...
export const fixtures: Fixture[] = [
  ...
  {name: 'djedOracleDatum', cddlFileName: 'djedOracleDatum.cddl'},
  {name: 'djedOrderDatum', cddlFileName: 'djedOrderDatum.cddl'},
  {name: 'djedPoolDatum', cddlFileName: 'djedPoolDatum.cddl'},
