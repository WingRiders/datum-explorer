...
![Blueprint integration mockups](mockups/1-blueprint-integration.png)
...
![Custom display mockups](mockups/2-custom-display.png)
...
![App theme switch mockups](mockups/3-app-theme.png)
...
![Tooltips mockups](mockups/4-tooltips.png)
...
![Highlight on hover mockups](mockups/5-highlight-on-hover.png)
...
![Error handling mockups](mockups/6-error-handling.png)
...
![Chrome extension mockups](mockups/7-chrome-extension.png)
